...
public class PostgresDatasourceConfigurationListener implements BeanCreatedEventListener<DatasourceConfiguration> {
    ...
    private String buildJdbcUrl() {
        ...
        return "jdbc:postgresql://" + postgres.getHost() + ":" + postgres.getPort() + "/" + postgres.getDatabase()
                + "?sslmode=" + sslMode
