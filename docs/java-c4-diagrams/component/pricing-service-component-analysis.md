...
1.  **External Systems & Services**:
    ...
    *   **Pricing Database**: A PostgreSQL database that stores the business rules for pricing (tariffs) and other related pricing data.
...
2.  **Internal Components**:
    ...
    *   **Tariff Repository**: An infrastructure-layer component implemented using Micronaut Data JPA that is responsible for finding and loading the correct MVEL tariff scripts from the **PostgreSQL database** based on the product being priced.